      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left animate-fade-in-up">
            ...
            {/* Clean Typography */}
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-poppins leading-tight mb-8 text-gray-900 dark:text-gray-800">
              Học tập
              <br />
            ...
            {/* Simple Description */}
            <p className="text-xl text-gray-600 leading-relaxed mb-12 max-w-2xl font-inter">
            ...
            <div className="grid grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="text-center">
                  ...
                  <div className="text-2xl font-bold text-blue-600 mb-1 font-poppins">{stat.number}</div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl bg-white p-4">
                ...
                <div className="absolute top-6 left-6 bg-white p-3 rounded-lg shadow-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Đang học online</span>
                  </div>
                </div>
                ...
                <div className="absolute bottom-6 left-6 bg-white p-3 rounded-lg shadow-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-gray-700">+25 điểm</div>
                      <div className="text-xs text-gray-500">Tiến bộ hôm nay</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h4 className="text-gray-900 font-semibold text-lg mb-2 font-poppins">{category.name}</h4>
                <p className="text-gray-600 text-sm font-inter">{category.students} sinh viên</p>
              </div>
            ))}
          </div>
        </div>
